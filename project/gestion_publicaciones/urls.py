...
from gestion_publicaciones.views import HomeView, TiendaView, GenerosView, AboutView, PublicacionCreateView, PublicacionDetailView, PublicacionUpdateView, PublicacionDeleteView, MensajeView
...
urlpatterns = [
    ...
    path('shop/publication_detail/<int:pk>/message/', MensajeView.as_view(), name='mensaje'),
